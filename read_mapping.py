...
#			name = file.split(os.extsep)
	input = foo[0]+"."+foo[1]+".sam"
	output = foo[0]+"."+foo[1]+".bam"
...
#		name = file.split(os.extsep)
	...
	PEin = foo[0]+".PE.bam"
	SEin = foo[0]+".SE.bam"
	Merge_out = foo[0]+".merge.bam"
	Sort_out = foo[0]+".merge.sort"
